...
export type Member={id:string;name:string;email:string;role:Role;suspended?:boolean};
...
export type Account={operator?:boolean;user:Identity;organizations:Organization[];invitations:Invitation[]};
