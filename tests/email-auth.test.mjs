...
test('legacy and email identities must review terms before entering pages and retain safe return paths',async()=>{
 const db=setup();try{
  ...
  assert.equal((await auth.requireAccount('/portal')).id,'legacy');
